...
class Notice extends Model
{
     ...
     * @return void
     */
    public static function pay_success_notice(int $xcx_id, string $openid, string $page = '/pages/index/index', string $prepay_id, string $order_no, string $product_name = '任意门奶茶', float $product_price, string $order_status,float $pay_price, string $pay_time)
    {
