...
class CreateDisplayBasicInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('displays_basic_infos', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('displays_basic_infos');
    }
}
